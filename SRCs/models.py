...
class Unidade(models.Model):
    ...
    numero_unidade = models.CharField("Número da unidade", max_length=10, blank=True, null=True)
...
class Envio(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    etiqueta = models.CharField("CÓDIGO DE RASTREIO", max_length=50, null=True, blank=True)
    ...
    numero_autorizacao = models.CharField("CÓDIGO DE POSTAGEM", max_length=20)
...
class Rateio(models.Model):
    ...
    etiqueta = models.ForeignKey(Envio, on_delete=models.CASCADE, db_column='etiqueta', verbose_name="ETIQUETA", null=True, blank=True)
